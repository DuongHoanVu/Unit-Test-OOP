import unittest
from clothing_Inheritance_modular import Clothing, Shirt, Pants, Blouse
...
class TestClothingClass(unittest.TestCase):
    ...
    def test_calculateshipping(self):
        # It should return error here, as not implementing calculate_shipping for clothing object yet
